    ...
    const classes=useStyles();
      ...
      <div>
             <Paper style={{boxShadow:"2px 2px 4px 4px grey" ,marginBottom:"10px",paddingBottom:"25px"}}>
              < Container>
              <div>
              <Typography variant="" component="h1" style={{fontSize:"42px",paddingBottom:"10px",paddingTop:"20px"}} >
             ...
             <span style={{float:"right",fontSize:"20px",paddingTop:"20px",paddingRight:"100px"}}>
               ...
               <div style={{paddingTop:"5px",display:"flex",flexWrap:"nowrap",justifyContent:"space-between",width:"100%",maxWidth:"1125px"}}>
              ...
              <strong>  Reserve Price not met</strong>   
                   ...
                   <span style={{fontSize:"13px",color:"red"}}>Closing in 3 Min
                   <span style={{paddingLeft:"60px",fontSize:"13px",color:"black"}}>
              <strong>     You have been outbid</strong>   </span>
                   </span>



                   <span style={{fontSize:"13px",color:"red"}} >Closing in 3 Min
                   <span style={{paddingLeft:"35px",fontSize:"13px",color:"green"}}>
              <strong>  You hold current highest bid</strong>   </span>
                   </span>
               </div>
