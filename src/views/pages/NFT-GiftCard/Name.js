...
export default function Name(){
    ...
    return(<div>
        ...
        <div className="Name" >
            ...
            <div className="Name2">
            <TextField variant="outlined"  placeholder="80's year Birthday" 
            ...
            <TextareaAutosize   rowsMin={7} placeholder="The Gift card to celebrate 80 year birthday " className="text2" color="primary"/>
            </div>
            <div  className="Name">
